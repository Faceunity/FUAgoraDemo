...
typedef NS_ENUM(NSInteger, AGMDispatcherQueueType) {
    ...
    // Used for operations on VideoFrame
    AGMDispatcherTypeVideoProcessing
};
...
+ (void)dispatchAsyncOnVideoProcessingQueueBlock:(dispatch_block_t)block;
+ (void)dispatchSyncOnVideoProcessingQueueBlock:(dispatch_block_t)block;
